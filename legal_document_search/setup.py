#!/usr/bin/env python3
"""
Setup script for the Indian Legal Document Retrieval System.
...
def create_directories():
    ...
    directories = ["documents", "data", "utils"]
...
def main():
    """Main setup function."""
    print("🚀 Setting up Indian Legal Document Retrieval System")
    print("=" * 60)
    ...
    if not install_spacy_model():
        print("⚠️  Warning: Failed to install spaCy model. NER features may not work properly.")
    ...
    print("3. Click 'Initialize System' to get started")
